...
#define LDO_FROM_NONE		0x00
#define LDO_FROM_CARD		0x01
#define LDO_FROM_DV33		0x02
...
enum RTSX_STAT	{RTSX_STAT_INIT, RTSX_STAT_IDLE, RTSX_STAT_RUN,
...
struct rtsx_chip {
	...
	int 			(*init_chip)(struct rtsx_chip *chip);
	...
	int card_reset_debounce;	
	int card_release_debounce;	
	...
	u8 rtl8411_ldo_tuned18;		
	u8 rtl8402_ldo_tuned18;		
...
#define RTL8411B		0x5287

#define CR_FIRST		0x01
#define NIC_FIRST		0x02

#define CHK_CR_FIRST(chip)	((chip)->perf_prior_valid && ((chip)->perf_prior == CR_FIRST))
#define CHK_NIC_FIRST(chip)	((chip)->perf_prior_valid && ((chip)->perf_prior == NIC_FIRST))
#define CHK_PRIOR_SET(chip)	(CHK_CR_FIRST(chip) || CHK_NIC_FIRST(chip))
